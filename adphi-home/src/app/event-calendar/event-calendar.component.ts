...
export class EventCalendarComponent {
  ...
  events = [
    ...
    { id: 2, title: 'Philanthropy Fundraiser', date: new Date(2026, 3, 10), location: 'Campus Quad', description: 'Supporting our local community.' },
    ...
    { id: 4, title: 'Recruitment Open House', date: new Date(2026, 5, 2), location: 'Chapter House', description: 'Meet the brothers and learn about us.' },
